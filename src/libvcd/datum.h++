...
namespace libvcd
{
    ...
    public:
        ...
        /* Comparison operator on a single datum -- this doesn't just
         * do a plain string comparison, it checks for radix, too!
         * The second operator is a helper function, which does the
         * comparison in one direction (we have to do it both
         * ways). */
